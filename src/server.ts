...
function isSupervisorEmail(email: string) {
  const allowedEmails = [process.env.SUPERVISOR_EMAIL, "isaac315@naver.com"]
    .map(normalizeEmail)
    .filter(Boolean);
