...
(() => {
  ...
  document.head.insertAdjacentHTML("beforeend", "<style>#shrine-create,#shrine-editor-modal,.shrine-grid th:nth-child(7),.shrine-grid th:nth-child(8),.shrine-grid td:nth-child(7),.shrine-grid td:nth-child(8){display:none!important}</style>");
